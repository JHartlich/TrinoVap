...
def command():
    Parser = argparse.ArgumentParser(
        prog="TrinoVap.py",
        usage="./%(prog)s TransDecoder FASTA Trinotate annotation report",
...
NewSt.write(
    "\nCOMPLETE    :\tSprot: %d\tPfam: %d\tKegg: %d"
    % (sp_count_c, pf_count_c, kg_count_c)
)
NewSt.write(
    "\nINTERNAL    :\tSprot: %d\tPfam: %d\tKegg: %d"
    % (sp_count_i, pf_count_i, kg_count_i)
)
NewSt.write(
    "\n5 PRIME PART:\tSprot: %d\tPfam: %d\tKegg: %d"
    % (sp_count_5, pf_count_5, kg_count_5)
)
NewSt.write(
    "\n3 PRIME PART:\tSprot: %d\tPfam: %d\tKegg: %d"
    % (sp_count_3, pf_count_3, kg_count_3)
)
